...
if average_grade <(82):
    print("Soryy you have failed the semester.")

if average_grade >(82):
    print("Congratulations! You have passed the semester.")

if math_grade <float(82):
    print("Sorry,but you have to re-enroll the Math subject.")

if science_grade <float(82):
    print("Sorry, but have to re-enroll the Science subject.")

if english_grade <float(82):
    print("Sorry, but you have to re-enroll the English subject.")
