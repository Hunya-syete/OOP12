...
print(" <(˶ᵔᵕᵔ˶)>  Hello, I was programmed to help compute your NetSalary!")
...
print("")
print(" ᕙ(  •̀ ᗜ •́  )ᕗ  Okay!, " + str(Name) + " doing " + str(Hours) + " Hour(s) of work per day.")
print("")
...
print("")
print("Your NetSalary is: Php " + str(NetSalary) + " ৻(  •̀ ᗜ •́  ৻)")