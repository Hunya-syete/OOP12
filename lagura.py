...
address1 = Address("new york", "tomas", "756 street", "5001")
address2 = Address("new york", "center", "354 street", "89001")

# Create instances of Person
person1 = Person("Jerry", "mie", "09533268218", "doctor")
person1.addresses.append(address1)
person2 = Person("Jude", "jay", "09895652812", "teacher")
person2.addresses.append(address2)

# Create instances of Employee and Trainer
employee = Employee("jerry", "mie", "095332682189", "doctor", "E001", True, "IT", "2020-01-01")
employee.addresses.append(address1)
trainer = Trainer("jude","jay", "09895652812", "teacher", "T001", "IT", 50000, [])
